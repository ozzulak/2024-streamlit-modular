...
if 'package' not in st.session_state:
    ...
    st.sidebar.text_input("Persona 1 label", key = "label_p1", value = "Therapist")
    st.sidebar.text_input("Persona 2 label", key = "label_p2", value = "Younger sibling")
    st.sidebar.text_input("Persona 3 label", key = "label_p3", value = "Friend")
