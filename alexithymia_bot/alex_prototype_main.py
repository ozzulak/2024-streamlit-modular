...
from alex_lc_prompts import *
from alex_lc_scenario_prompts import *
from alex_testing_prompts import * 
...
if st.session_state['consent']:
    st.set_page_config(page_title="Getting to know your emotions", page_icon="📖")
    st.title("Getting to know your emotions")
...
def summariseData(testing = False): 
    ...
    st.session_state.response_1 = chain.invoke({
        ...
        "example_behaviour": example_set['behaviour'],
        "example_thoughts" : example_set['thoughts'],
        "example_feel" : example_set['feel'],
        "example_mindful" : example_set['mindful'],
        "example_scenario" : example_set['scenario'],
        "what" : answer_set['what'],
        "context" : answer_set['context'],
        "behaviour": answer_set['behaviour'],
        "thoughts" : answer_set['thoughts'],
        "feel" : answer_set['feel'],
        "mindful" : answer_set['mindful']
    })
...
# we don't have consent yet -- ask for agreement and wait 
    ...
    with consent_message:
        ...
        #                 ''')
        st.markdown(''' 
                    ## 🎉 Welcome to our Let's-make-Dave-happy prototype! 🎉
